...
List<NeighborhoodLife> neighborhoodLifeList = [
  NeighborhoodLife(
    category: '우리동네질문',
    profileImgUri: 'https://picsum.photos/200/200',
    userName: '헬로비비',
    location: '좌동',
    content: '예민한 개도 미용할 수 있는 곳이나 동물 병원 어디 있을까요?\n'
        '내일 유기견을 데려오기로 했는데 아직 성향을 잘 몰라서 걱정이 돼요 ㅜㅜ.',
    contentImgUri: 'https://picsum.photos/200/400',
    commentCount: 11,
    authCount: 3,
    date: '3시간전',
  ),
  NeighborhoodLife(
    category: '우리동네소식',
    profileImgUri: 'https://picsum.photos/300/300',
    userName: '당근토끼',
    location: '우동',
    content: '이명 치료 잘 아시는 분 있나요?',
    contentImgUri: 'https://picsum.photos/300/300',
    commentCount: 2,
    authCount: 1,
    date: '1일전',
  ),
  ...
  NeighborhoodLife(
    ...
    contentImgUri: 'https://picsum.photos/200/200',
    commentCount: 11,
    authCount: 2,
    date: '5일전',
  ),
